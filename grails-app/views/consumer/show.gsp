            ...
            <div class="tab-content">
                <div class="tab-pane fade in active" id="tab1">
                   ...
                   <div class="row">
                       ...
                       <div class="col-md-4">
                        <g:if test="${consumerInstance?.user?.latitude && consumerInstance?.user?.longitude}">
                            <div style="width:100%; height: 300px;" id="gmap"></div>
                            <script>
                                function initMap() {
                                    var myLatLng = {lat: ${consumerInstance.user.latitude}, lng:  ${consumerInstance.user.longitude}};

...
<body>
<a href="#edit-transaction" class="skip" tabindex="-1"><g:message code="default.link.skip.label"
...
<div id="edit-transaction" class="content scaffold-edit" role="main">
    ...
    <g:form url="[resource: transactionInstance, action: 'update']" method="PUT" enctype="multipart/form-data">
